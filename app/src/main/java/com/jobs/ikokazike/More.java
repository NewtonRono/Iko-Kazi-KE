...
public class More extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        nummore = i.getExtras().getInt("pag");
        ...
        mRecyclerView = (RecyclerView)findViewById(R.id.act_recyclerview2);

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int i = nummore +1;
                Intent intent = new Intent(More.this,Next.class);
    ...
    public class Description extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(More.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            DataAdapter mDataAdapter = new DataAdapter(More.this, mJobTitleList, mBriefDescList, mDateList, mJobLink);
